...
if __name__ == '__main__':
    ...
    best_target = copy.deepcopy(model.target_net.state_dict())
    ...
    best_target_path = os.path.join(model_save_path, f'best_target_{best_epoch}_{best_rmse:.4f}.pth')
    torch.save(best_target, best_target_path)
